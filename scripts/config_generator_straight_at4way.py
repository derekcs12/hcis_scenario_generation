...
egoStraightAsideLeft = {
    "Start_pos": [0, 1, 40, 0, 1],
    "End_pos": [1, -1, 10, 0, 1],
    "Start_speed": 30,
}
egoStraightAsideRight = {
    "Start_pos": [0, 2, 40, 0, 1],
    "End_pos": [1, -2, 10, 0, 1],
    "Start_speed": 30,
}
...
if False:
    ...
    agent1_lat_event["Dynamic_delay"] = 5
...
if False:
    ...
    agent1_lat_event["Dynamic_duration"] = 2.5
    agent1_lat_event["Dynamic_shape"] = "sinusoidal"
    agent1_lat_event["End"] = [
        2,
        0,
    ]  # set_agentpos_relative_to_egopos(config['Ego']['Start_pos'], s_offset=1)
    agent1_lat_event["Use_route"] = None
...
if 1:
    ...
    for relative_pos in ["FL-M1", "FR-M1", "SL-M1", "SR-M1", "BL-M1", "BR-M1"]:
        ...
        agent1_lat_event["End"] = [
            ...
            -1,
            30,
            RELATIVE_TRIGGER_POSITIONS[relative_pos][4],
            1,
        ]
        agent1_lat_event["Use_route"] = None
