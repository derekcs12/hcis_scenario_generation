...
RELATIVE_TRIGGER_POSITIONS = { 
    ...
    # Motor/Bike
    "FL-M1": ("relative",  0,  0, 20, -1.5),
    "FL-M2": ("relative", -1,  0, 20,  1.5),
    "FL-M3": ("relative", -1,  0, 20, -1.5),
    "FR-M1": ("relative",  0,  0, 20,  1.5),
    "FR-M2": ("relative",  1,  0, 20, -1.5),
    "FR-M3": ("relative",  1,  0, 20,  1.5),
    ...
    "BL-M1": ("relative",  0,  0,  20, -1.5),
    "BL-M2": ("relative", -1,  0,  20,  1.5),
    "BL-M3": ("relative", -1,  0,  20, -1.5),
    "BR-M1": ("relative",  0,  0,  20,  1.5),
    "BR-M2": ("relative",  1,  0,  20, -1.5),
    "BR-M3": ("relative",  1,  0,  20,  1.5),
}
