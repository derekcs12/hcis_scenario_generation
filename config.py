...
RELATIVE_TRIGGER_POSITIONS = { 
    ...
    "FL-1": ("relative", -1,  0,  40,  0),
    "FS-2": ("relative",  0,  0,  40,  0),
    ...
    "FL-M2": ("relative", -1,  0, 40,  1.5),
    "FL-M3": ("relative", -1,  0, 40, -1.5),
    "FR-M1": ("relative",  0,  0, 40,  1.5),
    "FR-M2": ("relative",  1,  0, 40, -1.5),
    "FR-M3": ("relative",  1,  0, 40,  1.5),
